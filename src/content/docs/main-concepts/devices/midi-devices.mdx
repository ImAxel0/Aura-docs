...
SonoraMain.CreateMidiInputDevice(midiInputs[0]);
```

This is all we need to know to setup midi devices.

<CardGrid>
  <LinkCard title="Audio devices" href="/main-concepts/devices/audio-devices" description="Prev" />
  <LinkCard
    title="Audio clips"
    href="/main-concepts/clips/audio-clips"
    description="Next"
  />
</CardGrid>
